...
class Dialog1(wx.Dialog):
    def _init_ctrls(self, prnt):
        ...
        wx.Dialog.__init__(self, id=wxID_DIALOG1, name='', parent=prnt,
              pos=wx.Point(449, 263), size=wx.Size(419, 155),
              style=wx.DEFAULT_DIALOG_STYLE, title='Error')
        self.SetClientSize(wx.Size(411, 121))
        ...
        self.staticText1 = wx.StaticText(id=wxID_DIALOG1STATICTEXT1,
              label='Primero debes de elegir la carpeta inicial.',
              name='staticText1', parent=self, pos=wx.Point(64, 32),
              size=wx.Size(340, 19), style=0)
        ...
        self.botonAceptar = wx.Button(id=wxID_DIALOG1BOTONACEPTAR,
              ...
              pos=wx.Point(136, 80), size=wx.Size(112, 23), style=0)
