...
class Dialog1(wx.Dialog):
    def _init_ctrls(self, prnt):
        ...
        wx.Dialog.__init__(self, id=wxID_DIALOG1, name='', parent=prnt,
              pos=wx.Point(448, 273), size=wx.Size(393, 141),
              style=wx.DEFAULT_DIALOG_STYLE, title='Error')
        self.SetClientSize(wx.Size(385, 107))
        ...
        self.staticText1 = wx.StaticText(id=wxID_DIALOG1STATICTEXT1,
              label='No has elegido las carpetas destino.', name='staticText1',
              parent=self, pos=wx.Point(64, 32), size=wx.Size(293, 19),
              style=0)
        ...
        self.botonAceptar = wx.Button(id=wxID_DIALOG1BOTONACEPTAR,
              ...
              pos=wx.Point(120, 72), size=wx.Size(112, 23), style=0)
